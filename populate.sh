...
curl -H "Content-Type: application/json" -XPUT "$ADDRESS/get-together?include_type_name=true" -d@$(dirname $0)/mapping.json
...
curl -H "Content-Type: application/json" -XPOST "$ADDRESS/get-together/group/1?include_type_name=true" -d'{
  "name": "Denver Clojure",
...
echo
curl -H "Content-Type: application/json" -XPOST "$ADDRESS/get-together/group/2?include_type_name=true" -d'{
...
echo
curl -H "Content-Type: application/json" -XPOST "$ADDRESS/get-together/group/3?include_type_name=true" -d'{
...
echo
curl -H "Content-Type: application/json" -XPOST "$ADDRESS/get-together/group/4?include_type_name=true" -d'{
...
echo
curl -H "Content-Type: application/json" -XPOST "$ADDRESS/get-together/group/5?include_type_name=true" -d'{
...
curl -H "Content-Type: application/json" -XPOST "$ADDRESS/get-together/event/100?parent=1?include_type_name=true" -d'{
  "host": ["Lee", "Troy"],
...
echo
curl -H "Content-Type: application/json" -XPOST "$ADDRESS/get-together/event/101?parent=1?include_type_name=true" -d'{
  "host": "Sean",
...
echo
curl -H "Content-Type: application/json" -XPOST "$ADDRESS/get-together/event/102?parent=1?include_type_name=true" -d'{
  "host": "Daniel",
...
echo
curl -H "Content-Type: application/json" -XPOST "$ADDRESS/get-together/event/103?parent=2?include_type_name=true" -d'{
  "host": "Lee",
...
echo
curl -H "Content-Type: application/json" -XPOST "$ADDRESS/get-together/event/104?parent=2?include_type_name=true" -d'{
  "host": "Lee",
...
echo
curl -H "Content-Type: application/json" -XPOST "$ADDRESS/get-together/event/105?parent=2?include_type_name=true" -d'{
  "host": "Lee",
...
echo
curl -H "Content-Type: application/json" -XPOST "$ADDRESS/get-together/event/106?parent=3?include_type_name=true" -d'{
  "host": "Mik",
...
echo
curl -H "Content-Type: application/json" -XPOST "$ADDRESS/get-together/event/107?parent=3?include_type_name=true" -d'{
  "host": "Mik",
...
echo
curl -H "Content-Type: application/json" -XPOST "$ADDRESS/get-together/event/108?parent=3?include_type_name=true" -d'{
  "host": "Elyse",
...
echo
curl -H "Content-Type: application/json" -XPOST "$ADDRESS/get-together/event/109?parent=4?include_type_name=true" -d'{
  "host": "Andy",
...
echo
curl -H "Content-Type: application/json" -XPOST "$ADDRESS/get-together/event/110?parent=4?include_type_name=true" -d'{
  "host": "Andy",
...
echo
curl -H "Content-Type: application/json" -XPOST "$ADDRESS/get-together/event/111?parent=4?include_type_name=true" -d'{
  "host": "Andy",
...
echo
curl -H "Content-Type: application/json" -XPOST "$ADDRESS/get-together/event/112?parent=5?include_type_name=true" -d'{
  "host": "Dave Nolan",
...
echo
curl -H "Content-Type: application/json" -XPOST "$ADDRESS/get-together/event/113?parent=5?include_type_name=true" -d'{
  "host": "Dave",
...
echo
curl -H "Content-Type: application/json" -XPOST "$ADDRESS/get-together/event/114?parent=5?include_type_name=true" -d'{
  "host": "Yann",
...
curl -H "Content-Type: application/json" -XPOST "$ADDRESS/get-together/_refresh"
...
curl -H "Content-Type: application/json" -XPUT "http://$ADDRESS/_template/logging_index_all?include_type_name=true" -d'{
...
echo
curl -H "Content-Type: application/json" -XPUT "http://$ADDRESS/_template/logging_index?include_type_name=true" -d'{
    "template" : "logstash-*",
    "order" : 0,
    "settings" : {
        "number_of_shards" : 2,
...
curl -H "Content-Type: application/json" -XDELETE "http://$ADDRESS/myindex" > /dev/null
curl -H "Content-Type: application/json" -XPUT "http://$ADDRESS/myindex?include_type_name=true" -d'{
    "mappings" : {
        "my_type" : {
            "dynamic_templates" : [{
                "UUID" : {
...
echo
echo "Adding Aliases"
curl -H "Content-Type: application/json" -XDELETE "http://$ADDRESS/november_2014_invoices" > /dev/null
curl -H "Content-Type: application/json" -XDELETE "http://$ADDRESS/december_2014_invoices" > /dev/null
curl -H "Content-Type: application/json" -XPUT "http://$ADDRESS/november_2014_invoices?include_type_name=true" -d'{}'
echo
curl -H "Content-Type: application/json" -XPUT "http://$ADDRESS/december_2014_invoices?include_type_name=true" -d'{
    "mappings" :
    {
        "invoice" :
        {
...
curl -H "Content-Type: application/json" -XPOST "http://$ADDRESS/_aliases?include_type_name=true" -d '{
  "actions" : [
